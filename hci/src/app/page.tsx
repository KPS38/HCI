    ...
    <>
      ...
      <main className="content">
        ...
        <div className="relative w-full h-full">
          ...
          <div className="absolute inset-0 w-full h-full bg-black bg-opacity-60 pointer-events-none z-10"></div>
          {/* Main content */}
          <div className="relative z-20 flex flex-col items-center">
            {/* Hero Section */}
            <section
              className="items-center text-left min-h-screen text-white bg-black bg-opacity-50 bg-center
              max-w-6xl mx-auto mb-0 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-8 p-6"
            >
              <div className="items-center mt-16 gap-8 p-4 w-auto h-auto">
                ...
                <div className="items-center sm:mx-auto flex flex-col md:flex-row w-full gap-4">
                  <Link
                    href="/services"
                    className="group flex-1 px-6 py-3 my-4 bg-[#10B981] text-white font-medium rounded-lg text-center hover:bg-[#0e8e6f] transition-colors duration-300 min-w-[120px]"
                    style={{ width: "100%" }}
                  >
                    Services
                  </Link>
                  <Link
                    href="/certifications"
                    className="group flex-1 px-6 py-3 my-4 bg-[#1e1e1e] border-2 border-[#10B981] text-[#10B981] font-medium rounded-lg text-center hover:bg-[#0e8e6f] hover:border-[#0e8e6f] hover:text-white transition-colors duration-300 min-w-[120px]"
                    style={{ width: "100%" }}
                  >
                    Certifications
                  </Link>
            ...
            <section className="mx-auto bg-white bg-opacity-90 text-[#1e1e1e] dark:bg-[#1e1e1e] dark:bg-opacity-90 dark:text-white text-left w-full py-6 min-h-[60vh] items-center">
              ...
              <div className="max-w-4xl mx-auto sm:px-16 overflow-hidden" ref={emblaRef}>
                <div className="flex">
                  {certifications.map((cert, index) => (
                    <div
                      key={index}
                      className="embla__slide flex-none w-full sm:w-1/3 mx-4"
                    >
                      <div className="py-6 rounded-lg shadow-lg bg-white dark:bg-[#1e1e1e] flex flex-col items-center mb-4 max-w-[350px] mx-auto">
            ...
            {/* Story Section */}
            <section className="bg-white bg-opacity-90 text-[#1e1e1e] dark:bg-[#1e1e1e] dark:bg-opacity-90 dark:text-white text-left w-full py-6 min-h-[60vh]">
              <h2 className="text-3xl sm:text-5xl font-bold mb-12 text-center">
                Find Out More
              </h2>
